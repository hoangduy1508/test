...
if( ! nv_function_exists( 'nv_block_global_banners_slide' ) )
{
	function nv_block_global_banners_slide( $block_config )
	{
		...
		if( ! empty( $array_banners_content ) )
		{
			...
			if( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/banners/global.slide.tpl' ) )
			{
				$block_theme = $global_config['module_theme'];
			}
			elseif( file_exists( NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/banners/global.slide.tpl' ) )
			{
			...
			$xtpl = new XTemplate( 'global.slide.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/banners' );
			$stt = 0;
