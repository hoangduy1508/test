<!-- BEGIN: main -->
<script src="http://osakahotel.vn/themes/default/js/jssor.slider-26.6.0.min.js" type="text/javascript"></script>
...
<div class="page-header pd10_0 mg0_0_10">
	<h1 class="txt_bold titlephong">{ALBUM.name}</h1>
 ...
 <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:480px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <!-- BEGIN: loop_img -->
            <div>
                <img data-u="image" src="{PHOTO.file}" />
                <img data-u="thumb" src="{PHOTO.thumb}" />
            </div>
...
<!-- END: view_grid -->
<!-- BEGIN: other_album -->
<div class="page-header pd10_0 mg0_10_10" id="cacphongkhac">
